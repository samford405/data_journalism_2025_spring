...
# Step 1: Create a dataframe of Media expenses where the payee name is not NA
media_expenses <- maryland_expenses |>
  filter(`Expense Category` == "Media")|>
  filter(!is.na(`Payee Name`))

# Step 2: Write the dataframe to a CSV file in your data folder
...
**A4.**
The Ball Calvin Team seems to have 
```{r}
