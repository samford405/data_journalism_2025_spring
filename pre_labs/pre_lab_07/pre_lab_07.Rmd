...
The state with the largest percentage growth was Utah. It saw the biggest jump in population from 2000 to 2010, growing by over 20%.
...
A better headline would be: “Household Incomes Vary Across Maryland Counties — But Some Differences Are Within the Margin of Error.”
...
No, their error bars overlap, meaning the difference between Calvert and Montgomery counties is not statistically significant.

Is the difference between Howard and everyone else significant? **Answer**
Yes, Howard County’s income is significantly higher than all other counties, with non-overlapping error bars showing a clear difference.
...
The counties with the largest increases in median income from 2010 to 2021 were Howard, Montgomery, and Calvert.
A few smaller or rural counties saw little growth, but no Maryland counties experienced a drop in median income over that period.
...
High schools where 60% or more of graduates enrolled in college right away had a higher average household income, while schools with less than 40% enrollment were in lower-income areas.
This suggests a link between local income levels and college enrollment.
...
“Does average household income predict graduation rates, not just college enrollment?”