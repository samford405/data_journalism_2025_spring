...
In the space below, write the name of the business from the first row of the "name" column. **Answer** Directed Reseach
...
**Answer**its sorting term from earliest to later
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer**From highest to lowest in count classes
...
**Answer** its sorting to earliest term to latest term
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** The highest total seats to the lowest seats
...
**Answer** Its giving the mean and the median numbers of the set
...
1.  Which department tends to offer the largest classes (by average seats), and which departments offer the smallest?

2.How has the number of courses offered changed across different terms — are more classes being added over time, or fewer?

3.  Which instructors have taught the widest variety of courses, and which have taught the most sections overall?
