...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **It contains zipcode, zipnames along with shape length and area.**
...
**Task** Run the following code. Describe the output in the space below. **It shows the whole map of maryland and highlights certain parts that are darker then the other.**
...
**Task** Run the following code. Describe the output in the space below. **This one shows the counties along the entire county**
...
**Task** Run the following code. Describe the output in the space below. **It narrowed it all from the united staes to just maryland**
...
**Task** Run the following code. Describe the output in the space below. **It shows the whole state seperated by the counties**
...
**Task** Run the following code. Describe the output in the space below. **Shows the whole state and sorts it with counties along with the zipcodes**
...
**Task** Run the following code. Describe the output in the space below. **Sorts the forclosure data with the zipcode and the data from that code in 2023**
...
**Task** Run the following code. Describe the output in the space below. **The foreclosure data combined with zip code.**
...
**Task** Run the following code. Describe the output in the space below. **Its the zipcodes all color coded together with the foreclosure data linked in sorted by blue colors**
...
**Task** Run the following code. Describe the output in the space below. **each county divided sorted with the number notices**
...
**Task** Run the following code. Describe the output in the space below. **The number of people who live in each county of Maryland**
...
**Task** Run the following code. Describe the output in the space below. **number of notices in each county**
...
**Task** Run the following code. Describe the output in the space below. **Counties with the number of population in each county**
...
**Task** Run the following code. Describe the output in the space below. **notices and the population are now combined together**
...
**Task** Run the following code. Describe the output in the space below. **The county, notices, and the rates.**
...
**Task** Run the following code. Describe the output in the space below. **Shows the county and the zip code along with a number of oher things in seemingly Maryland**
...
**Task** Run the following code. Describe the output in the space below. **shows a chart of the rate of foreclosures in Maryland**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **That this map and the map before it are very similar**
