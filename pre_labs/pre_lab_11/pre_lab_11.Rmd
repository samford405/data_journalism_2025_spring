...
**Task** Run the following code and describe the dataframe it outputs. **It has names of alerts with those involved along with the type**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **It does no repeats**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Sepertaing each word that is used in its one row and coulmn**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **the amount that each word is used**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **shows the amount used and the percentage**
...
**Task** Run the following code and describe the results. **disciplinary was thw word used the most in both data frames **
...
**Task** Run the following code and describe the results. **health occ was the most used 2 word phrase in 2021**
...
**Task** Run the following code and describe the results. **health occ is still the mose used 2 word phrase but it was used more**
...
**Task** Run the following code and describe the results. **health occ going 3 for 3 with being the mose used 2 word phrase but the number went down a lot**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **They all seem accuratly put together where it belongs**
