...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer** some things are out of place
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer** I would need to use reframe to fix it
...
**Task** Run the codeblock below. What else do we need to do? **Answer** Filter
